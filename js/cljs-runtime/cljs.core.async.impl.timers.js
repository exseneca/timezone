...
var i_33383 = (0);
while(true){
if((i_33383 < arr.length)){
(arr[i_33383] = null);

var G__33384 = (i_33383 + (1));
i_33383 = G__33384;
continue;
} else {
}
...
var i_33393 = (self__.level + (1));
while(true){
if((i_33393 <= (new_level + (1)))){
(update[i_33393] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_33396 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33396[i]));
} else {
x__$2.forward.push((((i < links_33396.length))?(links_33396[i]):null));
}

if((i < links_33396.length)){
(links_33396[i] = x__$2);
} else {
links_33396.push(x__$2);
}
...
var links_33400 = (update[i_33399]).forward;
if((x__$1 === (((i_33399 < links_33400.length))?(links_33400[i_33399]):null))){
(links_33400[i_33399] = (x__$1.forward[i_33399]));

var G__33401 = (i_33399 + (1));
i_33399 = G__33401;
continue;
} else {
var G__33402 = (i_33399 + (1));
i_33399 = G__33402;
continue;
}
} else {
