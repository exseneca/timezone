...
var G__38671 = o;
reagent.impl.template.goog$module$goog$object.set(G__38671,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__38682 = o;
reagent.impl.template.goog$module$goog$object.set(G__38682,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__38683 = props;
var G__38683__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38683,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38683);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38683__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38690 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38690,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38690;
}
})(),id_class);
...
var G__38693 = (cljs.core.count(argv) - first_child);
switch (G__38693) {
case (0):
...
var vec__38694 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38694,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38694,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38694,(2),null);
...
var temp__5808__auto___38852 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___38852 == null)){
} else {
var key_38853 = temp__5808__auto___38852;
(jsprops.key = key_38853);
}
...
var temp__5808__auto___38861 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___38861 == null)){
} else {
var key_38862 = temp__5808__auto___38861;
(jsprops.key = key_38862);
}
...
var temp__5808__auto___38863 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___38863 == null)){
} else {
var key_38864 = temp__5808__auto___38863;
(jsprops.key = key_38864);
}
...
var temp__5808__auto___38868 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___38868 == null)){
} else {
var key_38869 = temp__5808__auto___38868;
(jsprops.key = key_38869);
}
...
var temp__5808__auto___38870 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___38870 == null)){
} else {
var key_38871 = temp__5808__auto___38870;
(jsprops.key = key_38871);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38726_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38726_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38736 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38736,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38736,(1),null);
...
break;
default:
var G__38883 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38884 = compiler;
v = G__38883;
compiler = G__38884;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template38776 = (function (opts,id,fn_to_element,parse_fn,meta38777){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38776.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38778,meta38777__$1){
var self__ = this;
var _38778__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38776(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38777__$1));
}));

(reagent.impl.template.t_reagent$impl$template38776.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38778){
var self__ = this;
var _38778__$1 = this;
return self__.meta38777;
}));

(reagent.impl.template.t_reagent$impl$template38776.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38776.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38776.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38776.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38776.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38776.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38777","meta38777",-1381476272,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38776.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38776.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38776");

(reagent.impl.template.t_reagent$impl$template38776.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template38776");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38776.
 */
reagent.impl.template.__GT_t_reagent$impl$template38776 = (function reagent$impl$template$__GT_t_reagent$impl$template38776(opts,id,fn_to_element,parse_fn,meta38777){
return (new reagent.impl.template.t_reagent$impl$template38776(opts,id,fn_to_element,parse_fn,meta38777));
});
...
return (new reagent.impl.template.t_reagent$impl$template38776(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
