...
var _STAR_print_newline_STAR__orig_val__30764_30862 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30765_30863 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30766_30864 = true;
var _STAR_print_fn_STAR__temp_val__30767_30865 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30766_30864);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30767_30865);

try{var _STAR_print_level_STAR__orig_val__30770_30866 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30771_30867 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30771_30867);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30770_30866);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30765_30863);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30764_30862);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq30753){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30753));
}));
...
var new_formatters = current_formatters.filter((function (p1__30780_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30780_SHARP_)));
}));
...
var G__30784_30877 = f;
var target__28115__auto___30878 = G__30784_30877;
if(cljs.core.truth_(target__28115__auto___30878)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30784_30877)].join(''),"\n","target__28115__auto__"].join('')));
}

(target__28115__auto___30878["toString"] = (function (){
...
var G__30786_30879 = "%c%s";
var G__30787_30880 = "color:transparent";
var G__30788_30881 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30786_30879,G__30787_30880,G__30788_30881) : f.call(null,G__30786_30879,G__30787_30880,G__30788_30881));
...
args__5775__auto__.push((arguments[i__5770__auto___30883]));
...
var vec__30797 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30797,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30797,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__30888__delegate = function (add_fmt,add_args){
...
var G__30888 = function (add_fmt,var_args){
var add_args = null;
...
while (G__30889__i < G__30889__a.length) {G__30889__a[G__30889__i] = arguments[G__30889__i + 1]; ++G__30889__i;}
  add_args = new cljs.core.IndexedSeq(G__30889__a,0,null);
} 
return G__30888__delegate.call(this,add_fmt,add_args);};
G__30888.cljs$lang$maxFixedArity = 1;
G__30888.cljs$lang$applyTo = (function (arglist__30890){
var add_fmt = cljs.core.first(arglist__30890);
var add_args = cljs.core.rest(arglist__30890);
return G__30888__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30791){
...
var G__30794 = cljs.core.first(seq30791__$2);
var seq30791__$3 = cljs.core.next(seq30791__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30792,G__30793,G__30794,seq30791__$3);
}));
...
var seq__30801 = cljs.core.seq(features);
var chunk__30802 = null;
var count__30803 = (0);
var i__30804 = (0);
while(true){
if((i__30804 < count__30803)){
var feature = chunk__30802.cljs$core$IIndexed$_nth$arity$2(null,i__30804);
...
var G__30899 = seq__30801;
var G__30900 = chunk__30802;
var G__30901 = count__30803;
var G__30902 = (i__30804 + (1));
seq__30801 = G__30899;
chunk__30802 = G__30900;
count__30803 = G__30901;
i__30804 = G__30902;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__30801);
if(temp__5804__auto__){
var seq__30801__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30801__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__30801__$1);
var G__30906 = cljs.core.chunk_rest(seq__30801__$1);
var G__30907 = c__5568__auto__;
var G__30908 = cljs.core.count(c__5568__auto__);
var G__30909 = (0);
seq__30801 = G__30906;
chunk__30802 = G__30907;
count__30803 = G__30908;
i__30804 = G__30909;
continue;
} else {
var feature = cljs.core.first(seq__30801__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__30913 = cljs.core.next(seq__30801__$1);
var G__30914 = null;
var G__30915 = (0);
var G__30916 = (0);
seq__30801 = G__30913;
chunk__30802 = G__30914;
count__30803 = G__30915;
i__30804 = G__30916;
continue;
}
} else {
...
var G__30826 = feature;
var G__30826__$1 = (((G__30826 instanceof cljs.core.Keyword))?G__30826.fqn:null);
switch (G__30826__$1) {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o30834 = temp__5802__auto__;
return (o30834["version"]);
} else {
return null;
}
})() == null);
